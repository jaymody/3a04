...
class SimonSays:
    ...
    def draw_startwindow(self):
        ...
        # x,y,width,height
        pygame.draw.rect(
            self.screen, (0, 0, 0), (58, 78, 650, 62))
        pygame.draw.rect(
            self.screen, (255, 255, 255), (60, 80, 640, 56))

        # The text
        instructionsText1 = self.font.render("Welcome to Simon Says! You have to click the buttons in the ", True, (0, 0, 0) )
        instructionsText2 = self.font.render("order they appear on the screen! Are you ready?", True, (0, 0, 0) )
    ...
    def play_minigame(self):
        ...
        playbutton = Button(self.screen, self.font, (0,200,220,), 150, 225, 250, 100, 'Play game')
